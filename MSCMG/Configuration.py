...
#REGEX_PATTERN: str = "(\[[A-Za-z0-9]+\]|<|Br?|Cl?|N|O|S|P|F|I|b|c|n|o|s|p|\(|\)|\.|=|#|-|\+|\\\\|\/|:|~|@|@@|\?|>|!|~|\*|\$|\%[0-9]{2}|[0-9])"
...
class Config:
    ...
    def set_config_paths(self):
        ...
        self.pretrain_data_path = os.path.join(
            self.base_path,
            "Pretraining_folder",
            fldr_struc["Pretraining_folder"]["dataset_folder"],
            "",
        )
        self.pretrain_weight_path = os.path.join(
            self.base_path,
            "Pretraining",
            fldr_struc["Pretraining_folder"]["weight_folder"],
            "",
        )
        self.pretrain_desc_path = os.path.join(
            self.base_path,
            "Pretraining",
            fldr_struc["Pretraining_folder"]["desc_folder"],
            "",
        )
        ...
        self.al_train_path = os.path.join(
            self.base_path,
            "ActiveLearning_folder",
            fldr_struc["ActiveLearning_folder"]["train_folder"],
            "",
        )
        self.al_weight_path = os.path.join(
            self.base_path,
            "ActiveLearning_folder",
            fldr_struc["ActiveLearning_folder"]["weight_folder"],
            "",
        )
